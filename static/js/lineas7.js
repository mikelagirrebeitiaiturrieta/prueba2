...
d3.csv("https://raw.githubusercontent.com/MikelAgirrebeitia/trabajo_internacional/main/exports.csv", function(error, data){
  ...
  var layout = {
    title: 'Evolución de las exportaciones',
    xaxis: {
      title:'Fecha',
  ...
  Plotly.newPlot('linea7', data, layout, config).then(function() {
    Plotly.addFrames('linea7', frames);
  });
});