...
d3.csv("https://raw.githubusercontent.com/MikelAgirrebeitia/trabajo_internacional/main/population.csv", function(error, data){
...
for(var i=0; i<paises.length; i++){
  if (['Ireland', 'Germany (until 1990 former territory of the FRG)', 'Italy', 'European Union - 28 countries (2013-2020)','European Union - 27 countries (from 2020)', 'index'].includes(paises[i])){
    ...
    // console.log(datos)
    var layout = {
      title: "Distribución de la población en Europa",
    ...
    var config = {responsive: true}
      Plotly.newPlot('tarta_2', datos, layout,config);
});